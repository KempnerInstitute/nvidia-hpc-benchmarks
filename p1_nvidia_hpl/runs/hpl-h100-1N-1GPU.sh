...
#SBATCH --time=2:00:00                 
#SBATCH --job-name="HPL_H100_1N_1GPU"           
...
# Example: if you want to mount extra directories, add them to BIND
# MOUNT="/path/to/my/dat-files:/workspace/dat-files"
...
srun --gres=gpu:1 \
     ...
     --dat /workspace/hpl-linux-x86_64/sample-dat/HPL-1GPU.dat
